...
# @router.post(
#     "/broadcast", response_model=NotificationResponseSchema, operation_id="broadcast"
# )
...
# @router.post(
#     "/individual", response_model=NotificationResponseSchema, operation_id="individual"
# )
...
#     operation_id="notification_detail",
# )
...
# @router.get(
#     "/stats", response_model=NotificationStatsSchema, operation_id="notification_stats"
# )
# async def get_stats(
#     db: AsyncSession = Depends(get_db),
#     current_user: User = Depends(get_current_user),
