...
async def food_item(async_db: AsyncSession, restaurant_vendor: User) -> Item:
    ...
    item_image = ItemImage(
        item_id=item.id, url="https://example.com/test-food-image.jpg", is_primary=True
    )
...
class TestOrderService:
    async def test_create_package_order_success(
        self,
        async_client: AsyncClient,
        create_charge_and_commission,
        authenticated_user,
    ):
        # Create a dummy file
        ...
        create_package = await async_client.post(
            f"{BASE_URL}/send-item", data=data, files=files, headers=headers
        )
    ...
    async def test_create_food_order_success(
        ...
        authenticated_restaurant_vendor,
        authenticated_user,
        food_item,
    ):
        ...
        assert (
            response_data["order"]["vendor_id"]
            == authenticated_restaurant_vendor["user"]["id"]
        )

    async def test_create_laundry_order_success(
        self,
        async_client: AsyncClient,
        authenticated_laundry_vendor,
        authenticated_user,
        laundry_item,
    ):
        ...
        assert (
            response_data["order"]["vendor_id"]
            == authenticated_laundry_vendor["user"]["id"]
        )

    async def test_create_package_order_invalid_coordinates(
    ...
    async def test_create_package_order_missing_image(
        self, async_client: AsyncClient, authenticated_user
    ):
        ...
        response = await async_client.post(
            f"{BASE_URL}/send-item", data=data, headers=headers
        )
        assert response.status_code == 422

    async def test_create_food_order_self_order_prevention(
        self, async_client: AsyncClient, authenticated_restaurant_vendor, food_item
    ):
    ...
    async def test_create_food_order_mixed_vendor_items(
        self,
        async_client: AsyncClient,
        async_db: AsyncSession,
        authenticated_user,
        ...
        other_vendor = await register_user(
            db=async_db, user_data=CreateUserSchema(**other_vendor_payload)
        )
        ...
        response = await async_client.post(
            f"{BASE_URL}/{restaurant_vendor.id}", json=order_data, headers=headers
        )

        assert response.status_code == 403
        assert "must belong to the same vendor" in response.json()["detail"]

    async def test_create_order_insufficient_profile_info(
        self, async_client: AsyncClient, async_db: AsyncSession, food_item
    ):
        ...
        user = await register_user(
            db=async_db, user_data=CreateUserSchema(**user_payload)
        )
        ...
        response = await async_client.post(
            f"{BASE_URL}/{food_item.user_id}", json=order_data, headers=headers
        )
    ...
    async def test_get_all_delivery_orders(
    ...
    async def test_get_all_delivery_orders_with_pagination(
    ...
    async def test_customer_confirm_order_received(
        self,
        async_client: AsyncClient,
        async_db: AsyncSession,
        authenticated_user,
        ...
        response = await async_client.put(
            f"{BASE_URL}/{order_id}/customer-confirm-order-received", headers=headers
        )
        assert response.status_code == 202
        response_data = response.json()
        assert response_data["order_status"] == OrderStatus.COMPLETED.value

    async def test_vendor_mark_order_delivered(
        self,
        async_client: AsyncClient,
        async_db: AsyncSession,
        authenticated_user,
        ...
        response = await async_client.put(
            f"{BASE_URL}/{order_id}/vendor-mark-order-delivered", headers=vendor_headers
        )
        assert response.status_code == 202
        response_data = response.json()
    ...
    async def test_generate_new_payment_link(
        self,
        async_client: AsyncClient,
        async_db: AsyncSession,
        authenticated_user,
        ...
        with patch(
            "app.utils.utils.get_payment_link",
            return_value="https://example.com/payment",
        ):
            response = await async_client.put(
                f"{BASE_URL}/{order_id}/generate-new-payment-link", headers=headers
            )
            assert response.status_code == 202
            response_data = response.json()
            assert "payment_link" in response_data

    async def test_unauthorized_access_to_order_operations(
        self,
        async_client: AsyncClient,
        async_db: AsyncSession,
        food_item,
    ...
    async def test_create_order_with_invalid_item_id(
        self, async_client: AsyncClient, authenticated_user, restaurant_vendor
    ):
    ...
    async def test_create_order_with_negative_quantity(
        self,
        async_client: AsyncClient,
        authenticated_user,
        food_item,
    ...
    async def test_rider_accept_delivery(
        self,
        async_client: AsyncClient,
        async_db: AsyncSession,
        authenticated_user,
        ...
        response = await async_client.put(
            f"{BASE_URL}/{order_id}/accept-delivery", headers=rider_headers
        )
        assert response.status_code == 202
        response_data = response.json()
        assert response_data["delivery_status"] == DeliveryStatus.ACCEPTED.value

    async def test_laundry_pickup_workflow(
        self,
        async_client: AsyncClient,
        async_db: AsyncSession,
        authenticated_user,
        ...
        create_response = await async_client.post(
            f"{BASE_URL}/{laundry_vendor.id}", json=order_data, headers=headers
        )
        assert create_response.status_code == 201
        order_id = create_response.json()["order"]["id"]
        ...
        pickup_response = await async_client.put(
            f"{BASE_URL}/{order_id}/pickup-laundry", headers=rider_headers
        )
    ...
    async def test_laundry_returned_workflow(
        self,
        async_client: AsyncClient,
        async_db: AsyncSession,
        authenticated_user,
        ...
        return_response = await async_client.put(
            f"{BASE_URL}/{order_id}/laundry-returned", headers=rider_headers
        )
    ...
    async def test_package_delivered_workflow(
        self,
        async_client: AsyncClient,
        async_db: AsyncSession,
        authenticated_user,
        ...
        delivered_response = await async_client.put(
            f"{BASE_URL}/{delivery_id}/package-delivered", headers=rider_headers
        )
    ...
    async def test_laundry_vendor_mark_item_received(
        self,
        async_client: AsyncClient,
        async_db: AsyncSession,
        authenticated_user,
        ...
        response = await async_client.put(
            f"{BASE_URL}/{delivery_id}/laundry-received", headers=vendor_headers
        )
        assert response.status_code == 202
        response_data = response.json()
        assert response_data["delivery_status"] == DeliveryStatus.RECEIVED.value

    async def test_re_list_item_for_delivery(
        self,
        async_client: AsyncClient,
        async_db: AsyncSession,
        authenticated_user,
        ...
        rider_headers = authenticated_rider["headers"]
        response = await async_client.put(
            f"{BASE_URL}/{delivery_id}/re-list-item", headers=rider_headers
        )
        assert response.status_code == 202
        response_data = response.json()
        assert response_data["delivery_status"] == DeliveryStatus.AVAILABLE.value

    async def test_cancel_delivery_with_reason(
        self,
        async_client: AsyncClient,
        async_db: AsyncSession,
        authenticated_user,
        ...
        response = await async_client.put(
            f"{BASE_URL}/{order_id}/cancel-delivery", json=cancel_data, headers=headers
        )
        assert response.status_code == 202
        response_data = response.json()
        assert response_data["delivery_status"] == DeliveryStatus.CANCELLED.value

    async def test_admin_modify_order_status(
        self,
        async_client: AsyncClient,
        async_db: AsyncSession,
        authenticated_user,
        authenticated_dispatch_admin,
        food_item,
        restaurant_vendor,
    ):
        ...
        admin_headers = {
            "Authorization": f"Bearer {authenticated_dispatch_admin['access_token']}"
        }
        response = await async_client.put(
    ...
    async def test_get_user_related_orders(
        self,
        async_client: AsyncClient,
        async_db: AsyncSession,
        authenticated_user,
    ...
    async def test_get_paid_pending_deliveries(
        self,
        async_client: AsyncClient,
        async_db: AsyncSession,
        authenticated_user,
        ...
        response = await async_client.get(
            f"{BASE_URL}/paid-pending-deliveries", headers=rider_headers
        )
        assert response.status_code == 200
        response_data = response.json()
        assert isinstance(response_data, list)

    async def test_create_review_for_order(
        self,
        async_client: AsyncClient,
        async_db: AsyncSession,
        authenticated_user,
        ...
        # Create review
        review_data = {"rating": 5, "comment": "Excellent service!"}
        response = await async_client.post(
            f"{BASE_URL}/{order_id}/review", json=review_data, headers=headers
        )
        assert response.status_code == 201
        response_data = response.json()
    ...
    async def test_create_order_with_delivery_requirements(
        self,
        async_client: AsyncClient,
        authenticated_user,
        food_item,
    ...
    async def test_create_order_with_additional_info(
        self,
        async_client: AsyncClient,
        authenticated_user,
        food_item,
