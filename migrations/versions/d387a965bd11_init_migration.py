...
def upgrade() -> None:
    ...
    sa.Column('category_type', sa.Enum('FOOD', 'PRODUCT', name='categorytype'), nullable=True),
    ...
    sa.Column('payout_charge_transaction_upto_5000_naira', sa.Numeric(), nullable=False),
    sa.Column('payout_charge_transaction_from_5001_to_50_000_naira', sa.Numeric(), nullable=False),
    sa.Column('payout_charge_transaction_above_50_000_naira', sa.Numeric(), nullable=False),
    ...
    sa.Column('user_type', sa.Enum('CUSTOMER', 'DISPATCH', 'RESTAURANT_VENDOR', 'LAUNDRY_VENDOR', 'RIDER', 'ADMIN', 'SUPER_ADMIN', 'MODERATOR', name='usertype'), nullable=False),
    ...
    sa.Column('account_status', sa.Enum('PENDING', 'CONFIRMED', name='accountstatus'), nullable=False),
    ...
    sa.Column('id', sa.Uuid(), nullable=False),
    sa.Column('item_type', sa.Enum('FOOD', 'PACKAGE', 'LAUNDRY', 'PRODUCT', name='itemtype'), nullable=False),
    ...
    sa.Column('food_group', sa.Enum('APPETIZER', 'MAIN_COURSE', 'DESSERT', 'OTHERS', name='foodgroup', create_constraint=True), nullable=True),
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.Column('updated_at', sa.DateTime(), nullable=False),
    ...
    sa.Column('order_type', sa.Enum('PACKAGE', 'FOOD', 'LAUNDRY', 'PRODUCT', name='ordertype'), nullable=False),
    ...
    sa.Column('order_payment_status', sa.Enum('FAILED', 'PAID', 'CANCELLED', 'PENDING', 'COMPLETED', 'SUCCESSFUL', name='paymentstatus'), nullable=False),
    sa.Column('order_status', sa.Enum('ACCEPTED', 'PENDING', 'DELIVERED', 'RECEIVED', 'CANCELLED', 'REJECTED', 'VENDOR_RECEIVED_LAUNDRY_ITEM', name='orderstatus'), nullable=True),
    sa.Column('require_delivery', sa.Enum('PICKUP', 'DELIVERY', name='requiredeliveryschema'), nullable=False),
    ...
    sa.Column('delivery_status', sa.Enum('ACCEPTED', 'PENDING', 'DELIVERED', 'RECEIVED', 'CANCELLED', 'VENDOR_RECEIVED_LAUNDRY_ITEM', name='deliverystatus'), nullable=False),
    sa.Column('delivery_type', sa.Enum('FOOD', 'LAUNDRY', 'PACKAGE', name='deliverytype'), nullable=False),
    ...
    sa.Column('review_type', sa.Enum('ORDER', 'PRODUCT', name='reviewtype'), nullable=False),
    ...
    sa.Column('transaction_type', sa.Enum('FUND_WALLET', 'PAY_WITH_WALLET', 'USER_TO_USER', 'WITHDRAWAL', 'REFUND', name='transactiontype'), nullable=False),
    sa.Column('transaction_direction', sa.Enum('CREDIT', 'DEBIT', name='transactiondirection'), nullable=True),
    sa.Column('payment_status', sa.Enum('FAILED', 'PAID', 'CANCELLED', 'PENDING', 'COMPLETED', 'SUCCESSFUL', name='paymentstatus'), nullable=False),
    sa.Column('payment_method', sa.Enum('WALLET', 'CARD', 'BANK_TRANSFER', name='paymentmethod'), nullable=True),
    sa.Column('payment_link', sa.String(), nullable=True),
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.Column('updated_at', sa.DateTime(), nullable=False),
    sa.ForeignKeyConstraint(['to_wallet_id'], ['users.id'], ),
    ...
    sa.Column('reported_user_type', sa.Enum('VENDOR', 'DISPATCH', 'CUSTOMER', name='reportedusertype'), nullable=False),
    sa.Column('report_tag', sa.Enum('COMPLAINANT', 'DEFENDANT', name='reporttag'), nullable=False),
    ...
    sa.Column('report_status', sa.Enum('PENDING', 'INVESTIGATING', 'RESOLVED', 'DISMISSED', name='reportstatus'), nullable=False),
    ...
    sa.Column('role', sa.Enum('CUSTOMER', 'DISPATCH', 'RESTAURANT_VENDOR', 'LAUNDRY_VENDOR', 'RIDER', 'ADMIN', 'SUPER_ADMIN', 'MODERATOR', name='usertype'), nullable=True),
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.Column('updated_at', sa.DateTime(), nullable=False),
    sa.ForeignKeyConstraint(['report_id'], ['user_reports.id'], ),
    sa.ForeignKeyConstraint(['sender_id'], ['users.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table('user_report_read_status',
    sa.Column('id', sa.Uuid(), nullable=False),
