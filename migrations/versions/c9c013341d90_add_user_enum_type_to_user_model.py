...
def upgrade() -> None:
    ...
    usertype = postgresql.ENUM(
        'CUSTOMER', 'DISPATCH', 'RESTAURANT_VENDOR', "MODERATOR", 'LAUNDRY_VENDOR','RIDER', 'ADMIN', 'STAFF', 'SUPER_ADMIN',
        name='usertype'
    )
    ...
    op.alter_column('users', 'user_type',
               ...
               type_=sa.Enum('CUSTOMER', 'DISPATCH', "MODERATOR", 'RESTAURANT_VENDOR', 'LAUNDRY_VENDOR', 'RIDER', 'ADMIN', 'STAFF', 'SUPER_ADMIN', name='usertype'),
...
def downgrade() -> None:
    ...
    # ### commands auto generated by Alembic - please adjust! ###
    op.alter_column('users', 'user_type',
               existing_type=sa.Enum('CUSTOMER', "MODERATOR", 'DISPATCH', 'RESTAURANT_VENDOR', 'LAUNDRY_VENDOR', 'RIDER', 'ADMIN', 'STAFF', 'SUPER_ADMIN', name='usertype'),
               type_=sa.VARCHAR(),
               existing_nullable=False)
    # ### end Alembic commands ###
