...
Revision ID: 2fb67cf2978c
Revises: 
Create Date: 2025-05-13 13:06:44.149768
...
def upgrade() -> None:
    ...
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('name', 'user_id', name='uq_name_item')
    )
    ...
    sa.Column('delivery_status', sa.Enum('PENDING', 'IN_TRANSIT', 'DELIVERED', 'RECEIVED', 'VENDOR_RECEIVED_LAUNDRY_ITEM', 'CANCELLED', name='delivertystatus'), nullable=False),
