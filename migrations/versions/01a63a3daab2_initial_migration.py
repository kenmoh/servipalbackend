...
Revision ID: 01a63a3daab2
Revises: 
Create Date: 2025-06-22 11:34:39.157429
...
def upgrade() -> None:
    ...
    sa.Column('issue_type', sa.Enum('DAMAGED_ITEMS', 'WRONG_ITEMS', 'LATE_DELIVERY', 'RIDER_BEHAVIOUR', 'CUSTOMER_BEHAVIOUR', 'OTHERS', name='issuetype'), nullable=False),
    sa.Column('issue_status', sa.Enum('PENDING', 'INVESTIGATING', 'RESOLVED', 'DISMISSED', name='issuestatus'), nullable=False),
    sa.Column('report_type', sa.Enum('VENDOR', 'CUSTOMER', 'DISPATCH', name='reporttype'), nullable=False),
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.Column('updated_at', sa.DateTime(), nullable=False),
    ...
    sa.Column('report_issue_id', sa.Uuid(), nullable=True),
    ...
    sa.ForeignKeyConstraint(['report_issue_id'], ['issues.id'], ),
