"""add VendorReviewStats

Revision ID: 5aa082698781
Revises: aed9c6443448
Create Date: 2025-06-17 16:19:56.076403
...
revision: str = '5aa082698781'
down_revision: Union[str, None] = 'aed9c6443448'
...
def upgrade() -> None:
    ...
    op.create_table('vendor_review_stats',
...
def downgrade() -> None:
    ...
    op.drop_table('vendor_review_stats')
    # ### end Alembic commands ###
