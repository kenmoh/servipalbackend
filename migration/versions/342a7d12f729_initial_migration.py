...
Revision ID: 342a7d12f729
Revises: 
Create Date: 2025-06-27 21:42:55.114984
...
def upgrade() -> None:
    ...
    sa.Column('user_type', sa.Enum('CUSTOMER', 'DISPATCH', 'RESTAURANT_VENDOR', 'LAUNDRY_VENDOR', 'RIDER', 'ADMIN', name='usertype'), nullable=False),
    ...
    sa.Column('order_status', sa.Enum('PENDING', 'DELIVERED', 'RECEIVED', 'CANCELLED', 'REJECTED', name='orderstatus'), nullable=True),
    ...
    sa.Column('account_status', sa.Enum('PENDING', 'CONFIRMED', name='accountstatus'), nullable=True),
    ...
    sa.Column('delivery_status', sa.Enum('ACCEPTED', 'PENDING', 'DELIVERED', 'RECEIVED', 'VENDOR_RECEIVED_LAUNDRY_ITEM', 'CANCELLED', name='deliverystatus'), nullable=False),
    ...
    sa.ForeignKeyConstraint(['order_id'], ['orders.id'], ),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('complainant_id', 'delivery_id', 'defendant_id', name='uq_reporter_delivery_report'),
